...
def make_flippys(locs, rots,
    ...
    if write_to_wbt:
        ...
        print('Template wbt file: /worlds/fimppy_sim_template.wbt')
        output_file_template = open('./worlds/flippy_sim_template.wbt', 'r').read()
...
if __name__=="__main__":
    # Create a swarm of flippys 4 wide, 1 tall, and 2
    dims = np.array([4,1, 2])
    # The average spacing between the flippys will be 0.15, 0.03 and 0.2
